...
public class FunctionFunctionalInterface implements Topic {
    @Override
    public void run() {
        ...
        CustomerUtility.filterCustomersAndGetName(customers, customer -> customer.getAge()>10,
                (String customerName) -> System.out.println(customerName), customer -> customer.getName());
    }
}
